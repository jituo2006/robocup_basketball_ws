...
用法：
    python3 tools/make_test_image.py --out /tmp/rb_test.png
    python3 tools/make_test_image.py --out /tmp/rb_test.png --check
"""
...
sys.path.insert(0, os.path.join(WS, "src", "rb_perception"))
