...
static const _MissionStatus_type_support_symbol_names_t _MissionStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rb_msgs, msg, MissionStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rb_msgs, msg, MissionStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rb_msgs, msg, MissionStatus)() {
  return &::rb_msgs::msg::rosidl_typesupport_c::MissionStatus_message_type_support_handle;
}
