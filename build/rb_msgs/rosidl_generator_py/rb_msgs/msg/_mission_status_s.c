...
bool rb_msgs__msg__mission_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rb_msgs.msg._mission_status.MissionStatus", full_classname_dest, 41) == 0);
  }
  rb_msgs__msg__MissionStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // elapsed_s
    ...
    ros_message->elapsed_s = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // score_estimate
    PyObject * field = PyObject_GetAttrString(_pymsg, "score_estimate");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->score_estimate = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * rb_msgs__msg__mission_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rb_msgs.msg._mission_status");
  ...
  {  // score_estimate
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->score_estimate);
    {
      int rc = PyObject_SetAttrString(_pymessage, "score_estimate", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
