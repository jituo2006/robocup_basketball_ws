...
class Metaclass_SetMission(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rb_msgs.srv import _set_mission
...
class SetMission(metaclass=Metaclass_SetMission):
    from rb_msgs.srv._set_mission import SetMission_Request as Request
    from rb_msgs.srv._set_mission import SetMission_Response as Response
