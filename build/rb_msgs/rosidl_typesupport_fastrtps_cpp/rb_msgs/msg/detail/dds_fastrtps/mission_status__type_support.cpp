...
#include "rb_msgs/msg/detail/mission_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rb_msgs::msg::MissionStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rb_msgs::msg::MissionStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rb_msgs::msg::MissionStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rb_msgs::msg::MissionStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rb_msgs::msg::MissionStatus *>(
    untyped_ros_message);
...
{
  return &rb_msgs::msg::typesupport_fastrtps_cpp::_MissionStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rb_msgs, msg, MissionStatus)() {
  return &rb_msgs::msg::typesupport_fastrtps_cpp::_MissionStatus__handle;
}
