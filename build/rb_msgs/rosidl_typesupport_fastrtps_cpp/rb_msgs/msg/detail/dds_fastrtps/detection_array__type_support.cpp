...
#include "rb_msgs/msg/detail/detection_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rb_msgs::msg::DetectionArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      rb_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rb_msgs::msg::DetectionArray & ros_message)
{
  // Member: header
  ...
  // Member: detections
  {
    ...
    for (size_t i = 0; i < size; i++) {
      rb_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        rb_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rb_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = rb_msgs::msg::DetectionArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rb_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rb_msgs::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  return &rb_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rb_msgs, msg, DetectionArray)() {
  return &rb_msgs::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
