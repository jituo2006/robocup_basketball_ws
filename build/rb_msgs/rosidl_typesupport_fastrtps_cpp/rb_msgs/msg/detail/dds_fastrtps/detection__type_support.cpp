...
#include "rb_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rb_msgs::msg::Detection & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.py;
  // Member: bbox_px_w
  cdr << ros_message.bbox_px_w;
  // Member: bbox_px_h
  cdr << ros_message.bbox_px_h;
  // Member: bearing_rad
  cdr << ros_message.bearing_rad;
  // Member: distance_m
  cdr << ros_message.distance_m;
  // Member: diameter_m
  cdr << ros_message.diameter_m;
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rb_msgs::msg::Detection & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  // Member: bbox_px_w
  {
    size_t item_size = sizeof(ros_message.bbox_px_w);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: bbox_px_h
  {
    size_t item_size = sizeof(ros_message.bbox_px_h);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: bearing_rad
  {
    size_t item_size = sizeof(ros_message.bearing_rad);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: distance_m
  ...
  // Member: diameter_m
  {
    size_t item_size = sizeof(ros_message.diameter_m);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rb_msgs::msg::Detection;
    is_plain =
      (
      offsetof(DataType, diameter_m) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const rb_msgs::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rb_msgs::msg::Detection *>(
    untyped_ros_message);
...
get_message_type_support_handle<rb_msgs::msg::Detection>()
{
  return &rb_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rb_msgs, msg, Detection)() {
  return &rb_msgs::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
