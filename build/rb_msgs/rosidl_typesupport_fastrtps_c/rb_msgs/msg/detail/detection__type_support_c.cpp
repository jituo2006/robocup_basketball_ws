...
#include "rb_msgs/msg/detail/detection__rosidl_typesupport_fastrtps_c.h"
...
using _Detection__ros_msg_type = rb_msgs__msg__Detection;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bbox_px_w
  {
    cdr << ros_message->bbox_px_w;
  }

  // Field name: bbox_px_h
  {
    cdr << ros_message->bbox_px_h;
  }

  // Field name: bearing_rad
  {
...
static uint32_t _Detection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rb_msgs__msg__Detection(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rb_msgs__msg__Detection;
    is_plain =
      (
...
static size_t _Detection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rb_msgs__msg__Detection(
